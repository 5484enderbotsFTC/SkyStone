...
@Autonomous(name = "JustParkFoundation", group = "Concept")

public class JustParkFoundation extends LinearOpMode {
    ...
    int initialStrafe = 16*ticksPerInchRound;
    int halfPark = 22*ticksPerInchRound;
    int strafePark = 26*ticksPerInchRound;
    int finishPark = 8*ticksPerInchRound;

    int straightPark = 42*ticksPerInchRound;
